...
from case.DF_project.DF_supplier.conftest import delete_register,delete_account_infor,delete_cards_infor,delete_changing_code
from case.VC_project.connect_mysql import select_sql,delete_db
from case.DF_project.DF_supplier.supplier import find_account_cards, update_account_information
from case.DF_project.DF_supplier.supplier import account_resetPWD, Add_supplier_card
from case.DF_project.DF_supplier.supplier import update_supplier_infor, supplier_loadown_template,import_company
from case.DF_project.DF_supplier.read_yaml import yaml_path, updata_company, find_company_infor, find_account_lists
from case.DF_project.DF_supplier.read_yaml import update_account_informations,add_supplier_infos
...
# 新增供应商数据
add_supplier_info_data=add_supplier_infos(curpathread)['add_supplier_info']
# 审核供应商卡号
# apporve=apporve_supplier_cards(curpathread)['apporve_supplier_card']
...
# def test_save_supplier_information_00(df_login_xadmin, delete_register, delete_account_infor):
#     '''
...
# @allure.tasecase("http://10.40.2.32:8898/api/edit_case/5/")
# @allure.testcase("")
...
class TestClass_card:
    ...
    def test_add_supplier_cards_02(self,df_login_xadmin,delete_register,delete_account_infor,delete_cards_infor,delete_changing_code,supplierFullName,businessType,supplierType,supplierStatus,
        ...
        with allure.step("step2 :点击新增卡号按钮"):
            ...
            supplier_card = Add_supplier_card(s).add_supplier_cards(supplierFullName=supplierFullName,businessType=businessType,supplierType=supplierType,
                                                                    ...
                                                                    plannedDeliveryTime=plannedDeliveryTime,minOrderAmount=minOrderAmount,
    ...
    @allure.story("审核供应商卡号")
    @allure.severity("normal")
    @allure.title("验证审核卡号通过功能的有效性")
    def test_approve_supplier_card_16(self,df_login_xadmin,delete_register,delete_account_infor,
                                    delete_cards_infor,delete_changing_code):
        '''
        验证审核有效性
        '''
        s = df_login_xadmin
        ...
        print("########sssssssssssss",supplier_hk)
        Add_supplier_card(s).get_companys(supplier_hk)
        supplier=Add_supplier_card(s).add_supplier_cards(supplierFullName="深圳大源源呐939",businessType="1",supplierType="1",supplierStatus="1",
                                            returnSupplier="1",contacts="22222",contactsPhone="18571519920",remark="",bizType="TO_C",
                                            supplierCode="9999010",supplierShortName="11111",taxType="Z1",
        ...
        approve = Add_supplier_card(s).approve_supplier_card(source_id='9999010',status='2')
        print("#@@@@@@@",approve)
    ...
    @allure.story("审核供应商卡号")
    @allure.severity("normal")
    @allure.title("验证审核卡号驳回功能的有效性")
    def test_approve_supplier_card_17(self,df_login_xadmin,delete_register,delete_account_infor,
                                    delete_cards_infor,delete_changing_code):
        '''
        验证审核有效性
        '''
        ...
        supplier=Add_supplier_card(s).add_supplier_cards(supplierFullName="深圳大源源呐939",businessType="1",supplierType="1",supplierStatus="1",
                                            returnSupplier="1",contacts="22222",contactsPhone="18571519920",remark="",bizType="TO_C",
                                            supplierCode="9999011",supplierShortName="11111",taxType="Z1",
                                            plannedDeliveryTime="1",minOrderAmount="0",orderCalendar="23",
                                            manualPriceRevision="1",autoConfirmOrders="0",settleCompany="10039",payType="1",
                                            drawer="",settlePeriod="2",settleMethod="2",accountPeriodStartDay="0",accountPeriod="30",
                                            grossProfitCompensate="2",paymentFreeze="0",generateZeroSettleSheet="0",checkStock="0",
        ...
        approve = Add_supplier_card(s).approve_supplier_card(source_id='9999011',status='4')
        print("#@@@@@@@",approve)
